  ...
  if ($lineShareChartEl) {
    ...
    var getDefaultOptions = function getDefaultOptions() {
      return {
        ...
        dataset: {
          source: [['product', '2012', '2013', '2014', '2015', '2016', '2017'], ['FC', 56.5, 82.1, 88.7, 70.1, 53.4, 85.1], ['FR', 51.1, 51.4, 55.1, 53.3, 73.8, 68.7], ['TA', 40.1, 62.2, 69.5, 36.4, 45.2, 32.5], ['SPO2', 25.2, 37.1, 41.2, 18, 33.9, 49.1]]
        },
        xAxis: {
          type: 'category',
          axisLine: {
