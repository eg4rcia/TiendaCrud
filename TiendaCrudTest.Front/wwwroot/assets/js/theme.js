...
var alerta1 = '<div class="position-fixed bottom-0" style="z-index: 5000; width:100%; padding: 10px;"><div class="toast fade" id="liveToast1" style="width:100%" role="alert" aria-live="assertive" aria-atomic="true"><div id="headToast" class="toast-header bg-success text-white"><strong class="me-auto">Mensaje</strong><small>Cerrar</small><button class="btn-close btn-close-white" type="button" data-bs-dismiss="toast" aria-label="Close"></button></div><div id="alertToast" class="alert alert-success border-2 d-flex align-items-center" role="alert"><div id="iconToast" class="bg-success me-3 icon-item"><span id="faToast" class="fas fa-check-circle text-white fs-3"></span></div><p id="msgToast" class="mb-0 flex-1">Mensaje</p></div></div></div>';
var alerta2 = '<div class="position-fixed bottom-0" style="z-index: 5000; width:100%; padding: 10px;"><div class="toast fade" id="liveToast2" style="width:100%" role="alert" aria-live="assertive" aria-atomic="true"><div id="headToast" class="toast-header bg-success text-white"><strong class="me-auto">Mensaje</strong><small>Cerrar</small><button class="btn-close btn-close-white" type="button" data-bs-dismiss="toast" aria-label="Close"></button></div><div id="alertToast" class="alert alert-success border-2 d-flex align-items-center" role="alert"><div id="iconToast" class="bg-success me-3 icon-item"><span id="faToast" class="fas fa-check-circle text-white fs-3"></span></div><p id="msgToast" class="mb-0 flex-1">Mensaje</p></div></div></div>';
var alerta3 = '<div class="position-fixed bottom-0" style="z-index: 5000; width:100%; padding: 10px;"><div class="toast fade" id="liveToast3" style="width:100%" role="alert" aria-live="assertive" aria-atomic="true"><div id="headToast" class="toast-header bg-success text-white"><strong class="me-auto">Mensaje</strong><small>Cerrar</small><button class="btn-close btn-close-white" type="button" data-bs-dismiss="toast" aria-label="Close"></button></div><div id="alertToast" class="alert alert-success border-2 d-flex align-items-center" role="alert"><div id="iconToast" class="bg-success me-3 icon-item"><span id="faToast" class="fas fa-check-circle text-white fs-3"></span></div><p id="msgToast" class="mb-0 flex-1">Mensaje</p></div></div></div>';
var alerta4 = '<div class="position-fixed bottom-0" style="z-index: 5000; width:100%; padding: 10px;"><div class="toast fade" id="liveToast4" style="width:100%" role="alert" aria-live="assertive" aria-atomic="true"><div id="headToast" class="toast-header bg-success text-white"><strong class="me-auto">Mensaje</strong><small>Cerrar</small><button class="btn-close btn-close-white" type="button" data-bs-dismiss="toast" aria-label="Close"></button></div><div id="alertToast" class="alert alert-success border-2 d-flex align-items-center" role="alert"><div id="iconToast" class="bg-success me-3 icon-item"><span id="faToast" class="fas fa-check-circle text-white fs-3"></span></div><p id="msgToast" class="mb-0 flex-1">Mensaje</p></div></div></div>';


function ToastSuccess(msg){
  document.getElementById("alertas").innerHTML = alerta1;
  document.getElementById("headToast").classList.add("bg-success");
  document.getElementById("alertToast").classList.add("alert-success");
  document.getElementById("iconToast").classList.add("bg-success");
  document.getElementById("faToast").classList.add("fa-check-circle");
  document.getElementById("msgToast").innerHTML = msg;
  var liveToast = new window.bootstrap.Toast(document.getElementById('liveToast1'));
      liveToast && liveToast.show();
}

function ToastInfo(msg){
  document.getElementById("alertas").innerHTML = alerta2;
  document.getElementById("headToast").classList.add("bg-info");
  document.getElementById("alertToast").classList.add("alert-info");
  document.getElementById("iconToast").classList.add("bg-info");
  document.getElementById("faToast").classList.add("fa-info-circle");
  document.getElementById("msgToast").innerHTML = msg;
  var liveToast = new window.bootstrap.Toast(document.getElementById('liveToast2'));
      liveToast && liveToast.show();
}

function ToastWarning(msg){
  document.getElementById("alertas").innerHTML = alerta3;
  document.getElementById("headToast").classList.add("bg-warning");
  document.getElementById("alertToast").classList.add("alert-warning");
  document.getElementById("iconToast").classList.add("bg-warning");
  document.getElementById("faToast").classList.add("fa-exclamation-circle");
  document.getElementById("msgToast").innerHTML = msg;
  var liveToast = new window.bootstrap.Toast(document.getElementById('liveToast3'));
      liveToast && liveToast.show();
}

function ToastError(msg){
  document.getElementById("alertas").innerHTML = alerta4;
  document.getElementById("headToast").classList.add("bg-danger");
  document.getElementById("alertToast").classList.add("alert-danger");
  document.getElementById("iconToast").classList.add("bg-danger");
  document.getElementById("faToast").classList.add("fa-times-circle");
  document.getElementById("msgToast").innerHTML = msg;
  var liveToast = new window.bootstrap.Toast(document.getElementById('liveToast4'));
      liveToast && liveToast.show();
}
...
var docReady = function docReady(fn) {
  ...
  if(document.getElementById("lblUsu")){
    document.getElementById("lblUsu").innerHTML = nom;
    if(document.getElementById("nomUsuario")){
      document.getElementById("nomUsuario").innerHTML = "Hola " + nom;
    }
  }
};
        ...
        case 'theme':
          {
            ...
            if(value == "dark"){
              if(document.getElementById("logoImg")){
                ...
                $("#date_picker").addClass("pm");
                $("#date_picker").removeClass("am");
              }             
            }
            else{
              if(document.getElementById("logoImg")){
                document.getElementById("logoImg").src = "img/logo1.png";
                $("#date_picker").addClass("am");
                $("#date_picker").removeClass("pm");
              }
            }
...
var toastInit = function toastInit() {
  ...
  if (liveToastBtn2) {
    var liveToast2 = new window.bootstrap.Toast(document.getElementById('liveToast2'));
    liveToastBtn2.addEventListener('click', function () {
      liveToast2 && liveToast2.show();
    });
  }

  var liveToastBtn3 = document.getElementById('liveToastBtn3');

  if (liveToastBtn3) {
    var liveToast3 = new window.bootstrap.Toast(document.getElementById('liveToast3'));
    liveToastBtn3.addEventListener('click', function () {
      liveToast3 && liveToast3.show();
    });
  }

  var liveToastBtn4 = document.getElementById('liveToastBtn4');

  if (liveToastBtn4) {
    var liveToast4 = new window.bootstrap.Toast(document.getElementById('liveToast4'));
    liveToastBtn4.addEventListener('click', function () {
      liveToast4 && liveToast4.show();
    });
  }
